...
public class UserServiceImpl implements UserService {
    ...
    public Response registerUser(RegistrationRequest registrationRequest) {
        ...
        if (registrationRequest.getRole() != null && !registrationRequest.getRole().isEmpty()) {
            try {
                role = UserRole.valueOf(registrationRequest.getRole().toUpperCase());
            } catch (IllegalArgumentException e) {
                log.warn("Invalid role '{}' provided. Defaulting to CUSTOMER.", registrationRequest.getRole());
            }
        }

        // Build user entity safely
